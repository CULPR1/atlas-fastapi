...
description = """registers a new user with user_id, 
password, role and name,
role can be buyer or seller

Important: Without any mention of user_id and password do not call the function, do not use default values
...
@app.post("/login", 
response_model = response,
description = "logs in a user with user_id and password, no default values, returns message and role if successful")
